...
void* FreeListAllocator::Allocate(const std::size_t size, const std::size_t alignment) {
    ...
    std::cout<<"ALLOCATION OPERATION, MEMORY ALLOCATED: "<<m_used<<" BYTES"<<std::endl;
...
void FreeListAllocator::Free(void* ptr) {
    ...
    std::cout<<"FREE OPERATION, DEALLOCATED MEMORY: "<<freeNode->data.blockSize<<" BYTES"<<std::endl;
    m_used -= freeNode->data.blockSize;
    Coalescence(itPrev, freeNode);  //merging
